...
import { Button, Modal, Box, TextField, Checkbox, FormControlLabel, Card, CardContent, Typography, CardMedia, Select, MenuItem, InputLabel, FormControl } from "@mui/material";
      ...
      <Modal open={open} onClose={handleClose}>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField label="Description" name="description" fullWidth margin="normal" multiline rows={3} value={newPost.description} onChange={handleChange} required />
